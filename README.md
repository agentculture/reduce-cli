...
uv run reduce-cli whoami  # identity from culture.yaml
uv run reduce-cli learn   # self-teaching prompt (add --json)
...
1. Rename the package `reduce/` and the `reduce-cli`
