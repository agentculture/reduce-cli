...
Every failure inside reduce-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`reduce.cli._output`,
...
# Exit-code policy. Documented in ``reduce-cli learn`` output.
# 0      = success
